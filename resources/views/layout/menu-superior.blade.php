<style media="screen">
.menu-superior{
    background-image: -webkit-gradient(linear,right top,left top,from(#EEAA7B),to(#E37222));
    background-image: -webkit-linear-gradient(right,#EEAA7B 0,#E37222 100%);
    background-image: -moz-linear-gradient(right,#EEAA7B 0,#E37222 100%);
    background-image: -o-linear-gradient(right,#EEAA7B 0,#E37222 100%);
    background-image: linear-gradient(to left,#EEAA7B 0,#E37222 100%);
...
<nav id="menu-superior" class="header-navbar navbar navbar-with-menu navbar-fixed-top navbar-semi-light bg-gradient-x-grey-blue menu-superior" style="">
    <div class="navbar-wrapper">
        <div class="navbar-header">
                ...
                <li class="nav-item"><a href="/" class="navbar-brand">
                    ...
                    <li class="nav-item">
                        <a href="/" class="navbar-brand">
                            ...
                            <!-- colocar imagem -->
                            <!-- <img alt="logo enviajus" src="{{asset('/app-assets/images/logo/stack-logo.png')}}" class="brand-logo" style="margin-left: -15px;" width="50"> -->
                            <!-- <img alt="logo enviajus" src="{{asset('/app-assets/images/logo/stack-logo.png')}}" class="brand-logo" style="margin-left: -15px;" width="50"> -->

                            <!-- <img alt="enviajus admin logo" src="{{asset('/assets/img/crypta/logo-nome.png')}}" class="brand-text brand-logo" style="margin-top: 5px;" width="94"> -->
                        </a>
                    </li>
                    <li class="nav-item hidden-md-up float-xs-right">
            ...
            <div class="navbar-container content container-fluid">
                <div id="navbar-mobile" class="collapse navbar-toggleable-sm">
                    ...
                    <!-- <li class="dropdown dropdown-user nav-item open"><a href="#" data-toggle="dropdown" class="dropdown-toggle nav-link dropdown-user-link" aria-expanded="true"><span class="avatar avatar-online"><img src="../../../app-assets/images/portrait/small/avatar-s-1.png" alt="avatar"><i></i></span><span class="user-name">John Doe</span></a>
        ...
        <ul class="nav navbar-nav">
        <li class="nav-item mobile-menu hidden-md-up float-xs-left"><a href="#" class="nav-link nav-menu-main menu-toggle hidden-xs"><i class="ft-menu font-large-1"></i></a></li>
        <li class="nav-item"><a href="index.html" class="navbar-brand"><img alt="stack admin logo" src="../../../app-assets/images/logo/stack-logo.png" class="brand-logo">
        <h2 class="brand-text">Stack</h2></a></li>
...
var appMenu = new Vue({
    ...
    methods: {
        clientesNovos : function(){
            url = urlBase+"/administracao/cliente-novos";
            this.$http.get(url)
            .then((response) => {
    ...
    filters : {
        formataData: function (data) {
            return moment(String(data)).format('l') +' às '+moment(String(data)).format('LT');
        }
    },
    created: function(){
        // this.clientesNovos();
